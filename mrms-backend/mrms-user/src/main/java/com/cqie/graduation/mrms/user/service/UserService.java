...
public interface UserService {
    ...
    abstract String login(Integer userId, String password, boolean rememberMe);
    ...
    abstract Set<String> findRoles(Integer userId);

    abstract Set<String> findPermissions(Integer userId);
}
